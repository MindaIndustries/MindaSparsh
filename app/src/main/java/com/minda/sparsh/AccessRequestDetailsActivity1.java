...
public class AccessRequestDetailsActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(AccessRequestDetailsActivity1.this);
                ...
                public void onResponse(@NotNull Call<List<AccessRequestPlantDetailModel>> call, @NotNull Response<List<AccessRequestPlantDetailModel>> response) {
                    ...
                    if (accessRequestPlantDetailModels != null && accessRequestPlantDetailModels.size() > 0) {
                        if (accessRequestPlantDetailModels.get(0).getAccessRequestNo() != null) {
                            PlantDetailsAdapter mAdapter = new PlantDetailsAdapter(response.body(), AccessRequestDetailsActivity1.this);
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(AccessRequestDetailsActivity1.this);
                ...
                public void onResponse(@NotNull Call<List<AccessRequestApproverDetailsModel>> call, @NotNull Response<List<AccessRequestApproverDetailsModel>> response) {
                    ...
                    if (responses != null) {
                        if (responses.get(0).getApprovalId() != null) {
                            AccessRequestApproverDetailsAdapter mAdapter = new AccessRequestApproverDetailsAdapter(response.body(), AccessRequestDetailsActivity1.this);
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(AccessRequestDetailsActivity1.this);
                ...
                public void onResponse(@NotNull Call<List<ARPDModel>> call, @NotNull Response<List<ARPDModel>> response) {
                    ...
                    if (responses != null && responses.size() != 0) {
                        if (responses.get(0).getApprovalId() != null) {
                            ...
                            ARPDAdapter mAdapter = new ARPDAdapter(response.body(), AccessRequestDetailsActivity1.this);
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(AccessRequestDetailsActivity1.this);
            ...
            response.enqueue(new Callback<String>() {
                ...
                public void onResponse(@NotNull Call<String> call, @NotNull Response<String> response) {
                    ...
                    if (responses != null && responses.equalsIgnoreCase("Request Approved successfully")) {
                        Toast.makeText(AccessRequestDetailsActivity1.this, responses, Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(getApplicationContext(), "Something went wrong", Toast.LENGTH_LONG).show();
                    }
